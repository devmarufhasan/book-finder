...
const Book = ({ book, setBooks, allBooks }) => {
  function handleFavorite() {
    setBooks(
      allBooks.map((ab) => {
        if (book.id === ab.id) {
          return { ...ab, isFavorite: !book.isFavorite };
        } else {
          return ab;
        }
      })
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-1">
            {Array.from({ length: book.star }, (value, index) => (
        ...
        <div className="flex items-center gap-3 text-xs lg:text-sm">
          ...
          <button
            ...
            className={`flex min-w-[132px] items-center justify-center gap-1 rounded-md lg:py-1.5 ${
              book.isFavorite
